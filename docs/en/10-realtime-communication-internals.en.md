...
- how remote `MediaStream` objects reach the React UI;
...
WebRTC provides browser-native mechanisms for media transport, encryption, codecs, congestion control, and related realtime media behavior.
